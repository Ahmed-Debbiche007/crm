    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'users')) active @endif" href="{{ route('users.index') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'abon') ||
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'depens')) active @endif"
