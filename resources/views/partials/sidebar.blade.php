    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            ...
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'users')) active @endif"
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'garage')) active @endif" href="{{ route('garages') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'echanc')) active @endif"
                        href="{{ route('echances') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <li class="nav-item">
                    <a class="nav-link @if (Illuminate\Support\Str::startsWith(request()->path(), 'charge')) active @endif"
                        href="{{ route('charges') }}">
                        <span
                            class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
