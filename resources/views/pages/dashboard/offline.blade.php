...
<body>
    ...
    <div class="w-100 h-100 d-flex justify-content-center align-items-center flex-column">
        <div class="navbar-brand navbar-brand-autodark p-5 rounded">
            @php
                $bon = App\Models\Settings::first();

            @endphp
            <img src="{{ asset('static/1.jpg') }}" style="width: 200px" alt="">
        </div>
        <div class="spinner-border text-primary" role="status">
            <span class="visually-hidden">Loading...</span>
        </div>
        <div>
            <h1 class="error-title text-center">Pas de connexion internet</h1>
