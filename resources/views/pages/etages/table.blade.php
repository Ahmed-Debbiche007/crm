                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class='table table-striped' id="table1">
                                    <thead>
                                        <tr>
                                            <th style="width: 40%" scope="col">Residence</th>
                                    ...
                                    <tbody>
                                        @foreach ($etages as $etage)
                                            <tr>
                                                <td style="width: 40%">{{ $etage->building->name }}</td>
                                                <td style="width: 40%">{{ $etage->number }}</td>
                                                <td>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="POST" action="{{ route('etages.store') }}"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <label>Numero: </label>
                                                    <div class="form-group">
                                                        <input type="number" name="number" placeholder="Addresse"
                                                            class="form-control">
                                                    </div>
                                                    <label>Plan: </label>
        ...
        editButtons.forEach((editButton) => {
            editButton.addEventListener('click', function() {
                ...
                axios.get(url).then((reponse) => {
                    ...
                    numberInput.value = etage.number;
                }).catch((error) => {
                    console.log(error)
                })
            });
